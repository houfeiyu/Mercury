(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, 'leaflet')) {
            ...
            inputScript("web/libs/leaflet/leaflet-src.js");
        }
        ...
        if (inArray(includes, 'leaflet.draw')) {
            inputCSS("web/libs/leaflet/plugins/leaflet.draw/0.4.9/leaflet.draw.css");
            inputScript("web/libs/leaflet/plugins/leaflet.draw/0.4.9/leaflet.draw.js");
        }
        if (inArray(includes, 'leaflet.pm')) {
            inputCSS("web/libs/leaflet/plugins/leaflet.pm/0.16.0/leaflet.pm.min.css");
            inputScript("web/libs/leaflet/plugins/leaflet.pm/0.16.0/leaflet.pm.min.js");
        }
    }
